...
let terrData = {
		...
		"Maro Peaks": {
			"routes": ["Skiens Island", "Tree Island"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 3600,
		...
		"Path To Thanos": {
			"routes": ["Cinfras Thanos Transition", "Thanos"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 3600,
		...
		"Sanctuary Bridge": {
			"routes": ["Nesaak Plains Upper North West", "Time Valley"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 0,
		...
		"Desert West Upper": {
			"routes": ["Desert Upper", "Almuj City"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 0,
		...
		"Path to Light": {
			"routes": ["Azure Frontier", "Otherwordly Monolith"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 0,
		...
		"The Silent Road": {
			"routes": ["The Broken Road", "Mine Base Plains"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 0,
		...
		"Canyon Mountain East": {
			"routes": ["Canyon Walk Way", "Canyon Valley South"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 7200,
		...
		"Cliffside Lake": {
			"routes": ["Cliffside Passage", "Canyon Of The Lost"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 0,
		...
		"Bremminglar": {
			"routes": ["Lion Lair", "Savannah West Upper"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 3600,
		...
		"Volcanic Slope": {
			"routes": ["Active Volcano", "Lava Lake"],
			"production": {
				"emerald": 1800,
				"wood": 900,
				"ore": 900,
		...
		"Canyon Waterfall North": {
			"routes": ["Canyon Upper North West"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 3600,
		...
		"Pirate Town": {
			"routes": ["Bloody Beach", "Lost Atoll", "Zhight Island"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 0,
		...
		"Desert West Lower": {
			"routes": ["Almuj City", "Desert Lower", "Desert Mid-Lower"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 0,
		...
		"Lone Farmstead": {
			"routes": ["Twisted Housing", "Abandoned Manor", "Gelibord"],
			"production": {
				"emerald": 9000,
				"wood": 3600,
				"ore": 0,
		...
		"Road to Elkurn": {
			"routes": ["Elkurn", "Elkurn Fields", "South Nivla Woods"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 0,
		...
		"Final Step": {
			"routes": ["Gateway to Nothing", "Bizarre Passage"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 0,
		...
		"Tree Island": {
			"routes": ["Light Peninsula", "Lost Atoll", "Volcano Upper"],
			"production": {
				"emerald": 9000,
				"wood": 3600,
				"ore": 0,
		...
		"Canyon Dropoff": {
			"routes": ["Mountain Path", "Cliff Side of the Lost"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 3600,
		...
		"Aldorei Valley Mid": {
			"routes": ["Aldorei Valley Upper", "Aldorei Valley Lower"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 0,
		...
		"Katoa Ranch": {
			"routes": ["Ragni North Suburbs", "Ragni North Entrance"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 0,
		...
		"Ragni North Suburbs": {
			"routes": ["Ragni North Entrance", "Ragni Plains", "Katoa Ranch"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 0,
		...
		"Durum Isles Lower": {
			"routes": ["Durum Isles Center", "Selchar", "Rooster Island"],
			"production": {
				"emerald": 9000,
				"wood": 3600,
				"ore": 0,
		...
		"Orc Battlegrounds": {
			"routes": ["Leadin Fortress", "Fortress South"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 3600,
		...
		"Path To Ozoth's Spire Lower": {
			"routes": ["Military Base Lower", "Thanos"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 3600,
		...
		"Worm Tunnel": {
			"routes": ["The Broken Road", "Grey Ruins"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 0,
		...
		"Active Volcano": {
			"routes": ["Lava Lake Bridge", "Lava Lake", "Volcanic Slope"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 0,
		...
		"Path to Cinfras": {
			"routes": ["Cinfras Entrance", "Light Forest East Upper"],
			"production": {
				"emerald": 9000,
				"wood": 3600,
				"ore": 0,
		...
		"Arachnid Route": {
			"routes": ["Plains", "North Nivla Woods", "Nemract Plains West"],
			"production": {
				"emerald": 9000,
				"wood": 3600,
				"ore": 0,
		...
		"Nesaak Bridge Transition": {
			"routes": ["Nesaak Plains South West", "Great Bridge Nesaak"],
			"production": {
				"emerald": 9000,
				"wood": 3600,
				"ore": 0,
		...
		"Heart of Decay": {
			"routes": ["Decayed Basin", "Mushroom Hill", "Lexdale"],
			"production": {
				"emerald": 9000,
				"wood": 3600,
				"ore": 0,
		...
		"Regular Island": {
			"routes": ["Jofash Docks", "Icy Island", "Dujgon Nation"],
			"production": {
				"emerald": 9000,
				"wood": 3600,
				"ore": 0,
		...
		"Pigmen Ravines": {
			"routes": ["Abandoned Farm", "Pigmen Ravines Entrance"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 3600,
		...
		"Swamp Mountain Transition Lower": {
			"routes": ["Swamp Mountain Transition Mid"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 0,
		...
		"Crater Descent": {
			"routes": ["Lava Lake Bridge", "Rodoroc", "Molten Heights Portal"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 3600,
		...
		"Bandit Camp Exit": {
			"routes": ["Canyon Valley South", "Canyon Path North Mid"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 3600,
		...
		"Ragni Main Entrance": {
			"routes": ["Ragni East Suburbs", "Emerald Trail", "Ragni"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 0,
		...
		"Canyon Fortress": {
			"routes": ["Canyon Waterfall Mid North", "Valley of the Lost"],
			"production": {
				"emerald": 1800,
				"wood": 900,
				"ore": 900,
		...
		"Burning Farm": {
			"routes": ["Ghostly Path", "Burning Airship"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 3600,
		...
		"Forgotten Town": {
			"routes": ["Grey Ruins", "Forest of Eyes"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 0,
		...
		"Nemract Quarry": {
			"routes": ["Nemract Road", "Plains Coast", "Nemract Plains West"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 3600,
		...
		"Gert Camp": {
			"routes": ["Gylia Lake North East", "Jitak's Farm"],
			"production": {
				"emerald": 9000,
				"wood": 3600,
				"ore": 0,
		...
		"Thesead": {
			"routes": ["Thesead Suburbs", "Entrance to Thesead South"],
			"production": {
				"emerald": 18000,
				"wood": 0,
				"ore": 3600,
		...
		"Military Base Upper": {
			"routes": ["Military Base Lower", "Military Base"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 3600,
		...
		"Otherwordly Monolith": {
			"routes": ["Path to Light", "Azure Frontier"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 0,
		...
		"Aldorei Valley West Entrance": {
			"routes": ["Hobbit River", "Aldorei Valley Lower", "Mantis Nest"],
			"production": {
				"emerald": 9000,
				"wood": 3600,
				"ore": 0,
		...
		"Raider's Base Upper": {
			"routes": ["Sky Island Ascent", "Raider's Base Lower"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 3600,
		...
		"Legendary Island": {
			"routes": ["Zhight Island", "Southern Outpost"],
			"production": {
				"emerald": 1800,
				"wood": 900,
				"ore": 900,
		...
		"Abandoned Pass": {
			"routes": ["Mining Base Upper", "Ternaves Plains Lower"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 3600,
		...
		"Corkus City Mine": {
			"routes": ["Road To Mine", "Corkus Statue", "Corkus Sea Cove"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 3600,
		...
		"Zhight Island": {
			"routes": ["Legendary Island", "The Bear Zoo", "Pirate Town"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 0,
		...
		"Entrance to Thesead North": {
			"routes": ["Entrance to Thesead South", "Cliffside Passage North"],
			"production": {
				"emerald": 9000,
				"wood": 3600,
				"ore": 0,
		...
		"Lighthouse Plateau": {
			"routes": ["Corkus Sea Port", "Phinas Farm", "Southern Outpost"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 0,
		...
		"Lexdales Prison": {
			"routes": ["Viscera Pits West", "Twisted Ridge"],
			"production": {
				"emerald": 9000,
				"wood": 7200,
				"ore": 0,
		...
		"Wybel Island": {
			"routes": ["Central Islands", "Sky Falls", "Ahmsord Outskirts"],
			"production": {
				"emerald": 9000,
				"wood": 3600,
				"ore": 0,
		...
		"Avos Temple": {
			"routes": ["Avos Workshop", "Bloody Beach"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 0,
		...
		"Ragni East Suburbs": {
			"routes": ["Maltic Plains", "Ragni Main Entrance", "Ragni Plains"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 0,
		...
		"Lost Atoll": {
			"routes": ["Tree Island", "Pirate Town", "Volcano Upper"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 0,
		...
		"Twisted Ridge": {
			"routes": ["Entrance to Kander", "Viscera Pits West"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 0,
		...
		"Canyon Survivor": {
			"routes": ["Cliff Side of the Lost", "Canyon Lower South East"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 0,
		...
		"Temple of the Lost East": {
			"routes": ["Krolton's Cave", "Valley of the Lost"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 3600,
		...
		"Gateway to Nothing": {
			"routes": ["Final Step", "Void Valley", "Toxic Drip"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 0,
		...
		"Molten Heights Portal": {
			"routes": ["Crater Descent", "Lava Lake Bridge", "Lava Lake"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 3600,
		...
		"Great Bridge Jungle": {
			"routes": ["Jungle Lower", "Herb Cave", "Great Bridge Nesaak"],
			"production": {
				"emerald": 9000,
				"wood": 3600,
				"ore": 0,
		...
		"Canyon Entrance Waterfall": {
			"routes": ["Canyon Path North West", "Canyon Path North Mid"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 3600,
		...
		"Aldorei's Arch": {
			"routes": ["Path To The Arch", "Canyon Waterfall North"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 3600,
		...
		"Gelibord Castle": {
			"routes": ["Gelibord Corrupted Farm", "Taproot Descent"],
			"production": {
				"emerald": 9000,
				"wood": 3600,
				"ore": 0,
		...
		"Llevigar Gate West": {
			"routes": ["Llevigar Farm Plains West", "Llevigar Gate East"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 3600,
		...
		"Great Bridge Nesaak": {
			"routes": ["Nesaak Bridge Transition", "Great Bridge Jungle"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 3600,
		...
		"Phinas Farm": {
			"routes": ["Royal Gate", "Lighthouse Plateau"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 0,
		...
		"Jofash Tunnel": {
			"routes": ["Jofash Docks", "Sky Island Ascent"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 3600,
		...
		"Viscera Pits East": {
			"routes": ["Path to Talor", "Viscera Pits West", "Lexdale"],
			"production": {
				"emerald": 9000,
				"wood": 3600,
				"ore": 0,
		...
		"The Broken Road": {
			"routes": ["Worm Tunnel", "The Silent Road"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 0,
		...
		"Aldorei's Waterfall": {
			"routes": ["Aldorei Valley Upper", "Aldorei Valley South Entrance"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 0,
		...
		"Dernel Jungle Lower": {
			"routes": ["Dernel Jungle Mid", "Jungle Lower"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 0,
		...
		"Forest of Eyes": {
			"routes": ["Sinister Forest", "Forgotten Town"],
			"production": {
				"emerald": 9000,
				"wood": 3600,
				"ore": 0,
		...
		"Meteor Crater": {
			"routes": ["Sablestone Camp", "Sunspark Camp", "Iron Road"],
			"production": {
				"emerald": 9000,
				"wood": 3600,
				"ore": 0,
		...
		"Astraulus' Tower": {
			"routes": ["Dragonling Nests", "Swamp Island"],
			"production": {
				"emerald": 9000,
				"wood": 3600,
				"ore": 0,
		...
		"Dead Island North West": {
			"routes": ["Dead Island South West", "Dead Island North East"],
			"production": {
				"emerald": 1800,
				"wood": 900,
				"ore": 900,
		...
		"Time Valley": {
			"routes": ["Little Wood", "Abandoned Farm", "Elkurn Fields"],
			"production": {
				"emerald": 9000,
				"wood": 3600,
				"ore": 0,
		...
		"Ghostly Path": {
			"routes": ["Burning Farm", "Path To The Arch"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 3600,
		...
		"North Nivla Woods": {
			"routes": ["Plains", "Nivla Woods Exit", "Nivla Woods Edge"],
			"production": {
				"emerald": 9000,
				"wood": 3600,
				"ore": 0,
		...
		"Bandit Cave Lower": {
			"routes": ["Canyon Valley South", "Path To Ozoth's Spire Upper"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 3600,
		...
		"Entrance to Rodoroc": {
			"routes": ["Rodoroc", "Thesead Suburbs", "Eltom"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 3600,
		...
		"Canyon Path South East": {
			"routes": ["Canyon Path North West", "Canyon Lower South East"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 3600,
		...
		"Pigmen Ravines Entrance": {
			"routes": ["Pigmen Ravines", "South Pigmen Ravines", "Ragni"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 3600,
		...
		"Corkus Outskirts": {
			"routes": ["Corkus Statue", "Bloody Beach", "Corkus Countryside"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 0,
		...
		"Nemract Plains East": {
			"routes": ["Nemract Road", "Detlas Trail West Plains"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 3600,
		...
		"Mansion of Insanity": {
			"routes": ["Twisted Housing", "Fortress North", "Fortress South"],
			"production": {
				"emerald": 1800,
				"wood": 900,
				"ore": 900,
		...
		"Efilim East Plains": {
			"routes": ["Efilim Village", "Efilim South East Plains"],
			"production": {
				"emerald": 9000,
				"wood": 3600,
				"ore": 0,
		...
		"Light Forest East Upper": {
			"routes": ["Efilim South East Plains", "Path to Cinfras"],
			"production": {
				"emerald": 9000,
				"wood": 3600,
				"ore": 0,
		...
		"Eltom": {
			"routes": ["Entrance to Rodoroc", "Ranol's Farm"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 0,
		...
		"Molten Reach": {
			"routes": ["Angel Refuge", "Molten Heights Portal"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 3600,
		...
		"Quartz Mines South East": {
			"routes": ["Quartz Mines South West", "Quartz Mines North East"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 3600,
		...
		"Dragonling Nests": {
			"routes": ["Snail Island", "Astraulus' Tower"],
			"production": {
				"emerald": 9000,
				"wood": 7200,
				"ore": 0,
		...
		"Grey Ruins": {
			"routes": ["Worm Tunnel", "Forgotten Town"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 0,
		...
		"Aldorei Valley Upper": {
			"routes": ["Aldorei Valley Mid", "Aldorei's Waterfall"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 0,
		...
		"Jitak's Farm": {
			"routes": ["Mushroom Hill", "Gert Camp", "Gylia Lake North West"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 0,
		...
		"Twain Lake": {
			"routes": ["Twain Mansion", "Nesaak Plains South West"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 0,
		...
		"Durum Isles East": {
			"routes": ["Mage Island", "Durum Isles Center"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 0,
		...
		"Aldorei's River": {
			"routes": ["Aldorei Lowlands", "Cinfras"],
			"production": {
				"emerald": 9000,
				"wood": 3600,
				"ore": 0,
		...
		"Cliffside Passage North": {
			"routes": ["Entrance to Thesead North", "Cliffside Passage"],
			"production": {
				"emerald": 9000,
				"wood": 3600,
				"ore": 0,
		...
		"Temple of Legends": {
			"routes": ["Jungle Lake", "City of Troms"],
			"production": {
				"emerald": 9000,
				"wood": 3600,
				"ore": 0,
		...
		"North Farmers Valley": {
			"routes": ["Maltic Coast", "South Farmers Valley"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 0,
		...
		"Ruined Houses": {
			"routes": ["Factory Entrance", "Fallen Factory", "Corkus Sea Port"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 0,
		...
		"Heavenly Ingress": {
			"routes": ["Field of Life", "Light Forest South Entrance"],
			"production": {
				"emerald": 9000,
				"wood": 3600,
				"ore": 0,
		...
		"Lutho": {
			"routes": ["Paths of Sludge", "Sinister Forest"],
			"production": {
				"emerald": 18000,
				"wood": 0,
				"ore": 0,
		...
		"Jungle Mid": {
			"routes": ["Jungle Lower", "Jungle Lake", "Jungle Upper"],
			"production": {
				"emerald": 9000,
				"wood": 3600,
				"ore": 0,
		...
		"Desert Upper": {
			"routes": ["Desert West Upper", "Desert Mid-Upper", "Mummy's Tomb"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 0,
		...
		"Southern Outpost": {
			"routes": ["Legendary Island", "Lighthouse Plateau"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 0,
		...
		"The Bear Zoo": {
			"routes": ["Rooster Island", "Zhight Island"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 0,
		...
		"Cherry Blossom Forest": {
			"routes": ["Ranol's Farm", "Chained House", "Hive South"],
			"production": {
				"emerald": 9000,
				"wood": 3600,
				"ore": 0,
		...
		"Wizard Tower North": {
			"routes": ["Krolton's Cave", "Bandits Toll"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 3600,
		...
		"Rymek West Lower": {
			"routes": ["Rymek East Lower", "Rymek West Mid"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 3600,
		...
		"Canyon Path North West": {
			"routes": ["Canyon Path South East", "Canyon Entrance Waterfall"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 0,
		...
		"Military Base": {
			"routes": ["Path To Military Base", "Military Base Upper"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 3600,
		...
		"Icy Descent": {
			"routes": ["Tower of Ascension", "Lusuco"],
			"production": {
				"emerald": 9000,
				"wood": 3600,
				"ore": 0,
		...
		"Aldorei Valley Lower": {
			"routes": ["Aldorei Valley Mid", "Aldorei Valley West Entrance"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 0,
		...
		"South Pigmen Ravines": {
			"routes": ["Little Wood", "Pigmen Ravines Entrance"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 3600,
		...
		"Abandoned Farm": {
			"routes": ["Pigmen Ravines", "Time Valley"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 0,
		...
		"Ragni North Entrance": {
			"routes": ["Katoa Ranch", "Ragni", "Ragni North Suburbs"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 0,
		...
		"Ranol's Farm": {
			"routes": ["Cherry Blossom Forest", "Thesead Suburbs", "Eltom"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 0,
		...
		"Light Forest South Exit": {
			"routes": ["Mantis Nest", "Light Forest North Exit"],
			"production": {
				"emerald": 9000,
				"wood": 3600,
				"ore": 0,
		...
		"Rymek East Lower": {
			"routes": ["Rymek East Mid", "Rymek West Lower"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 3600,
		...
		"Coastal Trail": {
			"routes": ["Maltic Coast", "Ragni Plains"],
			"production": {
				"emerald": 9000,
				"wood": 3600,
				"ore": 0,
		...
		"Kandon Ridge": {
			"routes": ["Old Coal Mine", "Kandon Farm", "Path to Ahmsord Upper"],
			"production": {
				"emerald": 9000,
				"wood": 3600,
				"ore": 0,
		...
		"Cliffside Passage": {
			"routes": ["Cliffside Passage North", "Cliffside Lake"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 3600,
		...
		"Corkus Statue": {
			"routes": ["Corkus City Mine", "Corkus Outskirts"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 0,
		...
		"Hive": {
			"routes": ["Thanos Exit Upper", "Hive South"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 0,
		...
		"Sky Falls": {
			"routes": ["Sky Island Ascent", "Frozen Fort", "Wybel Island"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 3600,
		...
		"Toxic Drip": {
			"routes": ["Paths of Sludge", "Gateway to Nothing", "Toxic Caves"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 0,
		...
		"Path To Ozoth's Spire Mid": {
			"routes": ["Canyon Walk Way", "Path To Ozoth's Spire Upper"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 3600,
		...
		"Path to Ahmsord Lower": {
			"routes": ["Sky Castle", "Ahmsord", "Path to Ahmsord Upper"],
			"production": {
				"emerald": 9000,
				"wood": 3600,
				"ore": 0,
		...
		"Path to Ahmsord Upper": {
			"routes": ["Path to Ahmsord Lower", "Kandon Ridge"],
			"production": {
				"emerald": 9000,
				"wood": 3600,
				"ore": 0,
		...
		"Canyon Mountain South": {
			"routes": ["Krolton's Cave", "Canyon Waterfall Mid North"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 3600,
		...
		"Angel Refuge": {
			"routes": ["Molten Reach", "Ahmsord Outskirts"],
			"production": {
				"emerald": 9000,
				"wood": 0,
				"ore": 0,
		...
		"Little Wood": {
			"routes": ["Time Valley", "South Pigmen Ravines"],
			"production": {
				"emerald": 9000,
				"wood": 3600,
				"ore": 0,
