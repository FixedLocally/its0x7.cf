...
function load_map() {
    ...
    function updateEco() {
        ...
        $("#em_count").html(`${usage.emerald} / ${prod.emerald}`);
        $("#wood_count").html(`${usage.wood} / ${prod.wood}`);
        $("#crop_count").html(`${usage.crop} / ${prod.crop}`);
        $("#ore_count").html(`${usage.ore} / ${prod.ore}`);
        $("#fish_count").html(`${usage.fish} / ${prod.fish}`);
    }
