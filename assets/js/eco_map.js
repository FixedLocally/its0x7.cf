...
let PROPS = ["damage", "attack", "health", "defense", "minions", "multi", "aura", "volley", "gather_xp", "mob_xp", "mob_damage", "pvp_damage", "xp_seeking", "tome_seeking", "eme_seeking","res_storage", "em_storage", "eff_res", "eff_em", "res_rate", "em_rate"];
...
function load_map() {
    ...
    function updateTerrStats(stats) {
        ...
        $("#terr_stats_dmg").html(`${Math.round(stats.stats.damage)}-${Math.round(1.5 * stats.stats.damage)} (avg Dps: ${((Math.round(stats.stats.damage) + Math.round(1.5 * stats.stats.damage)) / 2) * Math.round(stats.stats.attack * 100) / 100})`)
